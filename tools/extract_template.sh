...
xgettext *.php */*.php --copyright-holder='Databases Development Team' --package-name='GLPI - Databases plugin' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
